...
public class ControladoraUsuario {
    ...
    public ResponseEntity<?> crearReserva(@RequestParam("ccUsuario") String cc,
                                          @RequestParam("numAsiento") int asiento,
        ...
        // Crear reserva sin administrador? En el diagrama, Usuario puede crear reserva.
        // Pero el modelo Reserva requiere administrador (no nulo). Se puede asignar un admin por defecto (ej. id=1).
        // O modificar el modelo. Para este ejemplo, se asume admin por defecto.
        // Mejor se llama al endpoint de reserva pero con un admin genérico.
